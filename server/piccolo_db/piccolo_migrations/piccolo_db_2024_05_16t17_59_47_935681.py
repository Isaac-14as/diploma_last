...
async def forwards():
    manager = MigrationManager(
        migration_id=ID, app_name="piccolo_db", description=DESCRIPTION
    )
    ...
    manager.add_table(
        class_name="ValueDevice",
        tablename="value_device",
        schema=None,
        columns=None,
    )

    manager.add_table(
        class_name="AccidentLog",
        tablename="accident_log",
        schema=None,
        columns=None,
    )

    manager.add_table(
        class_name="ManagementLog",
    ...
    manager.add_column(
        table_class_name="ValueDevice",
        tablename="value_device",
        column_name="full_power",
        db_column_name="full_power",
    ...
    manager.add_column(
        table_class_name="ValueDevice",
        tablename="value_device",
        column_name="amperage",
        db_column_name="amperage",
        column_class_name="Float",
        column_class=Float,
        params={
            "default": 0.0,
    ...
    manager.add_column(
        table_class_name="ValueDevice",
        tablename="value_device",
        column_name="date_of_origin",
        db_column_name="date_of_origin",
    ...
    manager.add_column(
        table_class_name="ManagementLog",
        tablename="management_log",
        column_name="info",
        db_column_name="info",
        column_class_name="Varchar",
